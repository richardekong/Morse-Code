...
public class DecodeMorseCode 
{
  ...
  private static String [] Array2={"|","\"","!","&","'", "$", "+", "(", ")", ".", "/", ",","-", "3", "2", "1", "0", "7", "6", "5", "4", ";", ":", "9", "8", "?", "=", "D", "E", "F", "G", "@", "A", "B", "C", "L", "M", "N", "O", "H", "I", "J", "K", "U", "T", "W", "V", "Q", "P", "S", "R", "_", "Y", "X", "Z"};
 ...
 public static void main(String [] args)
 {
     ...
     System.out.println("Please enter Morse code to be converted:");
     String MorseCode=input.nextLine(); //holds the morse code value to be translated
     String space=" ";
     String decodedValue="";
     ...
     for (String word:words)//loops through each word in the array of words
     {
         ...
         for (String character:Characters)//loops through each character in word
         {
             ...
             for (int i=0; i<Array1.length;i++)//loops through the array containing morse code values, and decode every '.' to 'E's and '-' to 'T's
             {
                 if (character.equals(Array1[i]))//if the character equals items in array1, concatinate character's english equivalent to decoded value
                       decodedValue+=Array2[i];
             }
            }
     }
      ...
      System.out.printf("%s\n%s\n%s\n",MorseCode,"Translated to:",finalDecodedValue);
      System.out.println(setToSentenceCase(finalDecodedValue));
 ...
 public static String setToSentenceCase(String exp1)
 {
        ...
        for (int i=0;i<sentences.length;i++)
        {
            ...
            exp2+=(""+sentences[i].charAt(0)).toUpperCase()+sentences[i].substring(1,sentences[i].length()).toLowerCase()+dot+newLine;
